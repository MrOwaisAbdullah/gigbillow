...
export default function LandingPage() {
  ...
  const faqs = [
    ...
    {
      question: "Do my purchased tokens expire?",
      answer: "No, tokens you purchase never expire. Your free 10 monthly credits reset every 30 days and do not roll over, but your purchased token balance is yours to keep and use whenever you need it."
    },
    {
          ...
          <div className="container mx-auto flex max-w-6xl flex-col items-center justify-center space-y-8 px-4 text-center md:px-6">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-3xl text-muted-foreground md:text-xl">
                Replace Toggl + Wave + PandaDoc. OwFlex gives you full control with one simple, powerful app for time tracking, invoicing, and AI-powered proposals.
              </p>
            </div>
              ...
              <Card className="border-primary border-2 relative flex flex-col bg-background">
                ...
                <CardContent className="flex flex-col flex-grow space-y-4 p-6 pt-0">
                   <ul className="space-y-3 text-muted-foreground flex-grow">
                    ...
                    <li className="flex items-start gap-2"><Check className="h-4 w-4 mt-1 text-green-500 flex-shrink-0"/> Tokens never expire</li>
