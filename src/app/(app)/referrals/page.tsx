      ...
      <ReferralDashboard />
       ...
       <Card>
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
           ...
           <p><strong className="text-foreground">3. Earn Discounts:</strong> Based on the number of paying referrals, you'll earn coupons for discounts on your next subscription invoice.</p>
