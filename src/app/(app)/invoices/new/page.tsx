...
export default function NewInvoicePage() {
  ...
  async function onSubmit(values: InvoiceFormValues) {
    ...
    const hasEnoughTokensForPdf = await canAfford('invoice_pdf', 1);
    const hasEnoughTokensForWatermark = !values.removeWatermark || await canAfford('remove_watermark', 1);

    if (!hasEnoughTokensForPdf || !hasEnoughTokensForWatermark) {
        openDialog();
    ...
    try {
        ...
        delete (invoiceToCreate as any).removeWatermark;
